...
//#define BASE_BOARD_NAME WIZ750SR_DEVEL
#define BASE_BOARD_NAME	WIZ750SR_POE		// Add to the definitions some constraints for our POE Board
		...
		#define __USE_GPIOA_INPUT_ONLY__
		#define __ALLOW_GPIO_PULSE_TYPE__
		#endif
#endif
